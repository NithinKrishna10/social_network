...
class SendFriendRequestView(APIView):
    ...
    def post(self, request):
        ...
        if not to_user_id:
            return api_response(
                success=False, message="Recipient user ID is required", status=400
            )
        ...
        try:
            ...
            return api_response(
                success=False, message="Recipient user not found", status=404
            )
        ...
        if FriendRequest.objects.filter(from_user=from_user, to_user=to_user).exists():
            return api_response(
                success=False, message="Friend request already sent", status=400
            )
        ...
        if (
            ...
            return api_response(
                success=False, message="Friend request limit exceeded", status=429
            )
...
class RespondFriendRequestView(APIView):
    ...
    def post(self, request, pk):
        try:
            ...
            return api_response(
                success=False, message="Friend request not found", status=404
            )
        ...
        try:
            ...
            return api_response(
                success=True,
                message=f"Friend request {status_}",
                data=FriendRequestSerializer(friend_request).data,
            )
        except Exception as e:
            return api_response(
...
class ListFriendsView(generics.ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            return api_response(
                success=True, message="List of friends retrieved", data=serializer.data
            )
        except Exception as e:
            return api_response(
                success=False, message=f"An error occurred: {str(e)}", status=500
...
class ListPendingRequestsView(generics.ListAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            return api_response(
                success=True,
                message="List of pending friend requests retrieved",
